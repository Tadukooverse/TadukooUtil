...
public interface ThrowingFunction4<A, B, C, D, R, T extends Throwable>{
	...
	/**
	 * Creates a {@link ThrowingFunction4} that runs this {@link ThrowingFunction4} and
	 * puts the result into the given {@link ThrowingFunction}.
	 * 
	 * @param <S> The output type of the {@link ThrowingFunction}
	 * @param after A {@link ThrowingFunction} to put the result of this {@link ThrowingFunction4} into
	 * @return The {@link ThrowingFunction4} made from composing this {@link ThrowingFunction4} and the given {@link ThrowingFunction}
	 */
	 ...
	 * @param after A {@link Function} to put the result of this {@link ThrowingFunction4} into
	 * @return The {@link ThrowingFunction4} made from composing this {@link ThrowingFunction4} and the given {@link Function}
	 */
	default <S> ThrowingFunction4<A, B, C, D, S, T> andThen(Function<? super R, ? extends S> after){
		return (a, b, c, d) -> after.apply(this.apply(a, b, c, d));
	}
}
