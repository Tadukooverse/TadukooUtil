...
public interface Function9<A, B, C, D, E, F, G, H, I, R>{
	...
	/**
	 * Creates a {@link Function9} that runs this {@link Function9} and
	 * puts the result into the given {@link Function}.
	 *
	 * @param <S> The output type of the {@link Function}
	 * @param after A {@link Function} to put the result of this {@link Function9} into
	 * @return The {@link Function9} made from composing this {@link Function9} and the given {@link Function}
	 */
	default <S> Function9<A, B, C, D, E, F, G, H, I, S> andThen(Function<? super R, ? extends S> after){
		return (a, b, c, d, e, f, g, h, i) -> after.apply(this.apply(a, b, c, d, e, f, g, h, i));
	}
	
	/**
	 * Creates a {@link ThrowingFunction9} that runs this {@link Function9} and
	 ...
	 * @param after A {@link ThrowingFunction} to put the result of this {@link Function9} into
	 * @return The {@link ThrowingFunction9} made from composing this {@link Function9} and the given {@link ThrowingFunction}
	 */
	default <S, T extends Throwable> ThrowingFunction9<A, B, C, D, E, F, G, H, I, S, T> andThen(
