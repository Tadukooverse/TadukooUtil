...
/**
 * Represents a {@link ThrowingFunction} that takes two inputs and returns a long
 *
 ...
 */
@FunctionalInterface
public interface ThrowingToLongFunction2<A, B, T extends Throwable> extends ThrowingFunction2<A, B, Long, T>{
}
