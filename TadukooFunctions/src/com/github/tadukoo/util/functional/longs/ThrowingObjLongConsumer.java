...
/**
 * Represents a {@link ThrowingConsumer2} that consumes something and a long
 *
 ...
 */
@FunctionalInterface
public interface ThrowingObjLongConsumer<A, T extends Throwable> extends ThrowingConsumer2<A, Long, T>{
}
