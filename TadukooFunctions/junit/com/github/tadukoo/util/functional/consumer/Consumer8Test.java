...
public class Consumer8Test{
	...
	private Consumer8<Integer, Integer, Integer, Integer, Integer,
			Integer, Integer, Integer> add2;
	private ThrowingConsumer8<Integer, Integer, Integer, Integer, Integer,
			Integer, Integer, Integer, IllegalArgumentException> throwing;
	private ThrowingConsumer8<Integer, Integer, Integer, Integer, Integer,
			Integer, Integer, Integer, IllegalArgumentException> throwingSuccess;
	...
	public void setup(){
		...
		throwing = (i, j, k, l, m, n, o, p) -> {
			throw new IllegalArgumentException("Not supported");
		};
		throwingSuccess = (i, j, k, l, m, n, o, p) -> {
			value1 = i + 2;
			value2 = j + 2;
			value3 = k + 2;
			value4 = l + 2;
	...
	public void testConsumer8(){
		success.accept(5, 3, 17, 13, 23, 19, 209, 12);
	...
	public void testAndThenThrowing(){
		try{
			success.andThen(throwing).accept(5, 3, 17, 13, 23, 19, 209, 12);
			fail();
	...
	public void testAndThenThrowingSuccess(){
		success.andThen(throwingSuccess).accept(5, 3, 17, 13, 23, 19, 209,12);
		assertEquals(7, value1);
		assertEquals(5, value2);
		assertEquals(19, value3);
		assertEquals(15, value4);
