...
public class Consumer9Test{
	...
	private Consumer9<Integer, Integer, Integer, Integer, Integer,
			Integer, Integer, Integer, Integer> success;
	private Consumer9<Integer, Integer, Integer, Integer, Integer,
			Integer, Integer, Integer, Integer> add2;
	private ThrowingConsumer9<Integer, Integer, Integer, Integer, Integer,
			Integer, Integer, Integer, Integer, IllegalArgumentException> throwing;
	private ThrowingConsumer9<Integer, Integer, Integer, Integer, Integer,
			Integer, Integer, Integer, Integer, IllegalArgumentException> throwingSuccess;
	...
	public void setup(){
		...
		throwing = (i, j, k, l, m, n, o, p, q) -> {
			throw new IllegalArgumentException("Not supported");
		};
		throwingSuccess = (i, j, k, l, m, n, o, p, q) -> {
			value1 = i + 2;
			value2 = j + 2;
			value3 = k + 2;
			value4 = l + 2;
	...
	public void testConsumer9(){
		success.accept(5, 3, 17, 13, 23, 19, 209, 12, 75);
	...
	public void testAndThenThrowing(){
		try{
			success.andThen(throwing).accept(5, 3, 17, 13, 23, 19, 209, 12, 75);
			fail();
	...
	public void testAndThenThrowingSuccess(){
		success.andThen(throwingSuccess).accept(5, 3, 17, 13, 23, 19, 209,12, 75);
		assertEquals(7, value1);
		assertEquals(5, value2);
		assertEquals(19, value3);
		assertEquals(15, value4);
