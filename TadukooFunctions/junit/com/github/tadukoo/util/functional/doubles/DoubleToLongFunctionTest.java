...
import com.github.tadukoo.util.functional.longs.LongToDoubleFunction;
...
public class DoubleToLongFunctionTest{
	private ThrowingFunction<Long, Double, IllegalArgumentException> thrower;
	private DoubleToLongFunction success;
	private DoubleToLongFunction add2;
	private LongToDoubleFunction successReverse;
	private LongToDoubleFunction add2Reverse;
	private ThrowingFunction<Long, Double, IllegalArgumentException> throwingSuccess;
