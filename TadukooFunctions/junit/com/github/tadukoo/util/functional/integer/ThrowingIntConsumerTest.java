...
public class ThrowingIntConsumerTest{
	private int value;
	private ThrowingIntConsumer<IllegalArgumentException> success;
	private ThrowingIntConsumer<IllegalArgumentException> add2;
	private ThrowingIntConsumer<IllegalArgumentException> consumer;
	private Consumer<Integer> regularConsumer;
	...
	public void testAndThenRegularConsumer(){
		success.andThen(regularConsumer).accept(5);
