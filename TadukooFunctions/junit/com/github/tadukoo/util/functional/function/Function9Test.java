...
public class Function9Test{
	private Function9<Integer, Integer, Integer, Integer, Integer, Integer,
	...
	public void testFunction9(){
		assertEquals(45, success.apply(5, 5, 5, 5, 5, 5, 5, 5, 5));
	}
	...
	public void testAndThenThrowingSuccess(){
		assertEquals(47,
				success.andThen(throwingSuccess).apply(5, 5, 5, 5, 5, 5, 5, 5, 5));
	}
}
