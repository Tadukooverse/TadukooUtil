...
import com.github.tadukoo.util.functional.longs.LongConsumer;
import com.github.tadukoo.util.functional.longs.ThrowingLongBinaryOperator;
import com.github.tadukoo.util.functional.longs.ThrowingLongConsumer;
import com.github.tadukoo.util.functional.longs.ThrowingLongFunction;
import com.github.tadukoo.util.functional.longs.ThrowingLongPredicate;
...
import com.github.tadukoo.util.functional.longs.ThrowingLongUnaryOperator;
import com.github.tadukoo.util.functional.longs.ThrowingObjLongConsumer;
...
/**
 * Throwing Stream is a wrapper around {@link LongStream} that allows for the methods to throw {@link Throwable Throwables}
 *
 * @author Logan Ferree (Tadukoo)
 * @version Beta v.0.7
 */
public class ThrowingLongStream extends ThrowingBaseStream<Long, LongStream, ThrowingLongStream>{
	
	/**
	 * Constructs a new {@link ThrowingLongStream} by wrapping the given {@link LongStream} object
	 *
	 * @param stream The {@link LongStream} object being wrapped
	 */
	private ThrowingLongStream(LongStream stream){
		super(stream);
	}
	
	/**
	 * Wraps the given {@link LongStream} as a {@link ThrowingLongStream}
	 *
	 * @param stream The {@link LongStream} to be wrapped
	 * @return The {@link ThrowingLongStream} made by wrapping the {@link LongStream}
	 */
	public static ThrowingLongStream from(LongStream stream){
		return new ThrowingLongStream(stream);
	}
	
	/**
	 * Returns an empty sequential {@code ThrowingLongStream}.
	 *
	 * @return an empty sequential stream
	 * @see LongStream#empty()
	 */
	public static ThrowingLongStream empty(){
		return new ThrowingLongStream(LongStream.empty());
	}
	
	/**
	 * Returns a sequential {@code ThrowingLongStream} containing a single element.
	 *
	 * @param item the single element
	 * @return a singleton sequential stream
	 * @see LongStream#of(long)
	 */
	public static ThrowingLongStream of(long item){
		return new ThrowingLongStream(LongStream.of(item));
	}
	 ...
	 * @see LongStream#of(long...)
	 */
	public static ThrowingLongStream of(long ... items){
		return new ThrowingLongStream(LongStream.of(items));
	}
	
	/**
	 * Returns an infinite sequential ordered {@code ThrowingLongStream} produced by iterative
	 ...
	 *
	 * <p>The first element (position {@code 0}) in the {@code ThrowingLongStream} will be
	 ...
	 * @return a new sequential {@code ThrowingLongStream}
	 * @see LongStream#iterate(long, LongUnaryOperator)
	 */
	public static ThrowingLongStream iterate(final long seed, final LongUnaryOperator func){
		return new ThrowingLongStream(LongStream.iterate(seed, func));
	}
	
	/**
	 * Returns a sequential ordered {@code ThrowingLongStream} produced by iterative
	 ...
	 */
	public static ThrowingLongStream iterate(long seed, LongPredicate hasNext, LongUnaryOperator next){
		return new ThrowingLongStream(LongStream.iterate(seed, hasNext, next));
	}
	 ...
	 *
	 * @param supplier the {@code LongSupplier} for generated elements
	 * @return a new infinite sequential unordered {@code ThrowingLongStream}
	 * @see LongStream#generate(LongSupplier)
	 */
	public static ThrowingLongStream generate(LongSupplier supplier){
		return new ThrowingLongStream(LongStream.generate(supplier));
	}
	
	/**
	 * Returns a sequential ordered {@code ThrowingLongStream} from {@code startInclusive}
	 ...
	 * @return a sequential {@code ThrowingLongStream} for the range of {@code long} elements
	 * @see LongStream#range(long, long)
	 */
	public static ThrowingLongStream range(long startInclusive, long endExclusive){
		return new ThrowingLongStream(LongStream.range(startInclusive, endExclusive));
	}
	 ...
	 */
	public static ThrowingLongStream rangeClosed(long startInclusive, long endInclusive){
		return new ThrowingLongStream(LongStream.rangeClosed(startInclusive, endInclusive));
	}
	 ...
	 */
	public static ThrowingLongStream concat(ThrowingLongStream a, ThrowingLongStream b){
		return new ThrowingLongStream(LongStream.concat(a.stream(), b.stream()));
	}
	
	/** {@inheritDoc} */
	@Override
	public ThrowingLongStream sequential(){
		return ThrowingLongStream.from(stream.sequential());
	}
	
	/** {@inheritDoc} */
	@Override
	public ThrowingLongStream parallel(){
		return ThrowingLongStream.from(stream.parallel());
	}
	
	/** {@inheritDoc} */
	@Override
	public ThrowingLongStream unordered(){
		return ThrowingLongStream.from(stream.unordered());
	}
	
	/** {@inheritDoc} */
	@Override
	public ThrowingLongStream onClose(Runnable closeHandler){
		return ThrowingLongStream.from(stream.onClose(closeHandler));
	}
	...
	public <T extends Throwable> ThrowingLongStream filter(ThrowingLongPredicate<T> predicate) throws T{
		return ThrowingLongStream.from(stream.filter(item -> {
			try{
	 ...
	 */
	public <T extends Throwable> ThrowingLongStream map(ThrowingLongUnaryOperator<T> mapper) throws T{
		return ThrowingLongStream.from(stream.map(item -> {
			try{
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <U, T extends Throwable> ThrowingStream<U> mapToObj(ThrowingLongFunction<? extends U, T> mapper) throws T{
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> ThrowingIntStream mapToInt(ThrowingLongToIntFunction<T> mapper) throws T{
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> ThrowingDoubleStream mapToDouble(ThrowingLongToDoubleFunction<T> mapper) throws T{
	 ...
	 *               {@code ThrowingLongStream} of new values
	 * @return the new stream
	 * @throws T If the mapper throws it
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> ThrowingLongStream flatMap(ThrowingLongFunction<? extends LongStream, T> mapper) throws T{
		return ThrowingLongStream.from(stream.flatMap(item -> {
			try{
				return mapper.apply(item);
			}catch(Throwable t){
				throw sneakyThrow(t);
	 ...
	 * with an {@code LongConsumer} that accumulates replacement elements into a newly created
	 * internal buffer. When the mapper function returns, it creates an {@code longStream} from the
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> ThrowingLongStream mapMulti(ThrowingConsumer2<Long, LongConsumer, T> mapper) throws T{
		return ThrowingLongStream.from(stream.flatMap(item -> {
			try{
				List<Long> results = new ArrayList<>();
				mapper.accept(item, results::add);
				return results.stream().mapToLong(a -> a);
			}catch(Throwable t){
				throw sneakyThrow(t);
			}
		}));
	 ...
	 */
	public ThrowingLongStream distinct(){
		return ThrowingLongStream.from(stream.distinct());
	}
	 ...
	 */
	public ThrowingLongStream sorted(){
		return ThrowingLongStream.from(stream.sorted());
	}
	 ...
	 * @see LongStream#peek(java.util.function.LongConsumer)
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> ThrowingLongStream peek(ThrowingLongConsumer<T> action) throws T{
		return ThrowingLongStream.from(stream.peek(item -> {
			try{
				action.accept(item);
			}catch(Throwable t){
				throw sneakyThrow(t);
	 ...
	 */
	public ThrowingLongStream limit(long maxSize){
		return ThrowingLongStream.from(stream.limit(maxSize));
	}
	 ...
	 */
	public ThrowingLongStream skip(long n){
		return ThrowingLongStream.from(stream.skip(n));
	}
	 ...
	 * Using an unordered stream source (such as {@link #generate(LongSupplier)})
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> ThrowingLongStream takeWhile(ThrowingLongPredicate<T> predicate) throws T{
		return ThrowingLongStream.from(stream.takeWhile(item -> {
			try{
				return predicate.test(item);
			}catch(Throwable t){
				throw sneakyThrow(t);
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> ThrowingLongStream dropWhile(ThrowingLongPredicate<T> predicate) throws T{
		return ThrowingLongStream.from(stream.dropWhile(item -> {
			try{
				return predicate.test(item);
			}catch(Throwable t){
				throw sneakyThrow(t);
	 ...
	 * @throws T If the action throws it
	 * @see LongStream#forEach(java.util.function.LongConsumer)
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> void forEach(ThrowingLongConsumer<T> action) throws T{
		stream.forEach(item -> {
			try{
				action.accept(item);
			}catch(Throwable t){
	 ...
	 *               non-interfering</a> action to perform on the elements
	 * @throws T If the action throws it
	 * @see #forEach(ThrowingLongConsumer)
	 * @see LongStream#forEachOrdered(java.util.function.LongConsumer)
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> void forEachOrdered(ThrowingLongConsumer<T> action) throws T{
	 ...
	 *
	 * <pre>{@code
	 *     long sum = Longs.reduce(0, (a, b) -> a+b);
	 * }</pre>
	 *
	 * or more compactly:
	 *
	 * <pre>{@code
	 *     long sum = Longs.reduce(0, Long::sum);
	 * }</pre>
	 *
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> long reduce(long identity, ThrowingLongBinaryOperator<T> op) throws T{
	 ...
	 * @return the result of the reduction
	 * @throws T If the op throws it
	 * @see #reduce(long, ThrowingLongBinaryOperator)
	 * @see LongStream#reduce(LongBinaryOperator)
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> OptionalLong reduce(ThrowingLongBinaryOperator<T> op) throws T{
	 ...
	 * }</pre>
	 *
	 * <p>Like {@link #reduce(long, ThrowingLongBinaryOperator)}, {@code collect} operations
	...
	public <R, T extends Throwable, T2 extends Throwable, T3 extends Throwable> R collect(
			ThrowingSupplier<R, T> supplier, ThrowingObjLongConsumer<R, T2> accumulator,
	 ...
	 * operation</a>.
	 *
	 * @return an {@code longSummaryStatistics} describing various summary data
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> boolean anyMatch(ThrowingLongPredicate<T> predicate) throws T{
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> boolean allMatch(ThrowingLongPredicate<T> predicate) throws T{
	 ...
	 */
	@SuppressWarnings("RedundantThrows")
	public <T extends Throwable> boolean noneMatch(ThrowingLongPredicate<T> predicate) throws T{
	 ...
	 *
	 * @return an {@code OptionalLong} describing some element of this stream, or
	 * an empty {@code OptionalLong} if the stream is empty
	 * @see #findFirst()
	 ...
	 */
	public ThrowingStream<Long> boxed(){
