...
/**
 * A {@link MappedPojo} used for testing that returns {@code false} for {@link #hasKey(String)} on the second run
 *
 ...
 */
public abstract class MappedPojoBadHasKey2<V> implements MappedPojo, DefaultTestValues{
