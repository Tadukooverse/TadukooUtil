...
/**
 * A {@link MappedPojo} used for testing that makes the keys null on {@link #clear()}
 *
 ...
 */
public class MappedPojoBadClearNullKeys<V> implements MappedPojo, DefaultTestValues{
	private final Map<String, Object> map;
	private boolean doBad;
	
	public MappedPojoBadClearNullKeys(){
		map = new HashMap<>();
		doBad = false;
	}
